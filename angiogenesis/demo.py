...
from interface.app import InteractiveDemoApp
...
def main():
    ...
    root.deiconify()
    app.mainloop()
#python segnext/demo.py --checkpoint=weights/vitb_sa2_cocolvis_hq44k_epoch_0.pth
def parse_args():
    parser = argparse.ArgumentParser()

    parser.add_argument('--checkpoint', type=str, required=False, default="last_checkpoint.pth",
    ...
    parser.add_argument('--limit-longest-size', type=int, default=1024,
