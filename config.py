...
class Config():
    def __init__(self) -> None:
        ...
        self.compile = False and (not self.use_fp16)     # 1. Trigger CPU memory leak in some extend, which is an inherent problem of PyTorch.
        ...
        self.weights_root_dir = os.path.join('E:\\avatarget\\deeplearning\\segmentation\\birefnet_tensorrt-main\\BiRefNetmain', 'weights')
        self.weights = {
            'swin_v1_b': os.path.join(self.weights_root_dir, ['swin_base_patch4_window12_384_22kto1k.pth', 'swin_base_patch4_window12_384_22k.pth'][0]),
            'swin_v1_l': os.path.join(self.weights_root_dir, ['swin_large_patch4_window12_384_22kto1k.pth', 'swin_large_patch4_window12_384_22k.pth'][0]),
            'swin_v1_t': os.path.join(self.weights_root_dir, ['swin_tiny_patch4_window7_224_22kto1k_finetune.pth'][0]),
            'swin_v1_s': os.path.join(self.weights_root_dir, ['swin_small_patch4_window7_224_22kto1k_finetune.pth'][0]),
            #'swin_v1_t':os.path.join(self.weights_root_dir, ['BiRefNet-general-bb_swin_v1_tiny-epoch_232.pth'][0]),
        }
